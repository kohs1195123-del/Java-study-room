...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        *  형변환은 크게 두 가지 주요 방식으로 나눌수 있는데
        *  암시적 형변환 VS 명시적 형변환 이렇게 2가지가 있다
        * 
        * 암시적 형변환
        * - 작은 범위의 데이터 타입에서 큰 범위의 타입으로 자동으로
        * 변환되는 과정을 의미한다.
        * -iny(4byte) -> double(8byte)의 경우, 데이터 손실이 발생하지 
        * 읺는다.
        * */
        
        // 명시적 형변환 예
        double dnum = 99.99; //double 은 8byte
        int inum = (int) dnum; //  손실을 감수하고 변경하겠다. 명사
