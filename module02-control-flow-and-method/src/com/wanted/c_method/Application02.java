...
public class Application02 {
    ...
    public void methodA() {
         ...
         // 4. 호출 확인을 위한 출력 구문
        System.out.println("methodA()  호출된...");
    ...
    public void methodB() {
        ...
        // 9. methodA 와 같은 방식으로 호출 확인을 위한 출력 구문
        System.out.println("methodB()  호출된...");

        // 10. 작성만 해두고 APP을 동작시켜본다.
        // 실행을 하면 methodB의 출력구문은 동작하지 않는다.
        // 오ㅐ냐 부르지 않았기 떄문에
